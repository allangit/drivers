...
ax01.set_title('Position vs Time',color="c")
ax02.set_title('Velocity vs Time',color="green")
ax03.set_title('Position and Velocity vs Time',color="green")
...
simulation = animation.FuncAnimation(f0, updateData, blit=False, frames=2000, interval=20, repeat=False)
